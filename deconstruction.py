...
class Ratio_Components:
    ...
    "Price_to_Earnings" : {
        "components": {'1' : ["price_to_book", "return_on_equity"], '2': ["price_to_sale", "net_profit_margin"]},
        "type": {'1' : ["fraction"], '2': ["fraction"]},
        "formula": {'1' : "price_to_book / return_on_equity", '2': "price_to_sale / net_profit_margin"},
        "analysis_depth": Null,
    ...
    def __init__(self, company: Company):
        self.company_inputs = company.var_list
        self.company_ratios = company.output
